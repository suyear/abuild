...
function initLayout(){
	...
	if(window.parent != window)
		...
		$("#container .tabsPageContent").height(iContentH+27 ).find("[layoutH]").layoutH();
	
	$("#sidebar, #sidebar_s .collapse, #splitBar, #splitBarProxy").height(iContentH + 57);
	
	$("#mainwrap").height(iContentH-87);
