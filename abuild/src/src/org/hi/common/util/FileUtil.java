...
public class FileUtil {
	...
	public static Map<String, Integer> getImgWidthHeight(String filePath){
		File file = new File(filePath);
		return getImgWidthHeight(file );
	}
	public static Map<String, Integer> getImgWidthHeight(File file){
		int imgWidth=0;
		int imgHeight=0;
		try {			
