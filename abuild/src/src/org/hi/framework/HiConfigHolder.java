...
public class HiConfigHolder {
     ...
     * @return
     */
    public static String getRootUploadJXM(){
        String upload_jxm = getProperties().getProperty("hi.depolyment.juximao.rootupload");
        ObjectNull();
        if(upload_jxm == null ||upload_jxm.trim().equals(""))
            return "upload";
        return upload_jxm;
    }
    ...
    //上传目录
    public static String getUploadRoootPath()
    {
    	String rootPath = getProperties().getProperty("hi.upload.root");
        ObjectNull();
        return rootPath;    	
    }
    ...
    public static String getPasswordSalt(){
        String password_salt = getProperties().getProperty("hi.security.user.password.salt");
        ObjectNull();
    ...
    {
    	String web_root = getProperties().getProperty("hi.juximao.web.root");
        ObjectNull();
        return web_root==null?"":web_root;    	
    }
    ...
    {
    	String img_root = getProperties().getProperty("hi.juximao.img.root");
        ObjectNull();
        return img_root==null?"":img_root;    	
    }
     ...
     * @return
     */
    public static int getPinImgWidth()
    {
    	String img_width = getProperties().getProperty("hi.juximao.pin.img_width");
        ObjectNull();
        return Integer.valueOf(img_width);    	
    }
}
